...
import JSReferDetail from './components/pages/JSReferDetail';
...
function App(){
  return(
    <Router>
      ...
      <Route path="/css-refer-detail" component={CssReferDetail} />
      <Route path="/js-refer-detail" component={JSReferDetail} />
